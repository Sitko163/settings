...
# Регионы погоды на дашборде; можно переопределить через DASHBOARD_WEATHER_REGIONS JSON в .env
...
def get_dashboard_weather(region_id=None):
